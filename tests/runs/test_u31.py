...
class Test_U31(unittest.TestCase):    
    def init(self):
    ...
    def test_standard_config(self):
        ...
        namelist_base.soil_biogeochemistry_ctl.sb_model_scheme.value = SbModelScheme.JSM
    ...
    def compare_outputs(self):
        ...
        ref_path = '/Net/Groups/BSI/work/quincy/model/reference_runs/cruncepv7_subset_u30_31/20250220_develop_342ef5f8/exp_31_progress_options_short_transient_cruncep_jsm_342ef5f8'
...
if __name__ == "__main__":
    tu31 = Test_U31()
    tu31.init()
    tu31.test_standard_config()
    
    tu31.compare_outputs()
