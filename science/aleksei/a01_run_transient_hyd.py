...
PARTITION = 'work'
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/aalipavskii/simulations/QPy/hydraulics/a01_test/"
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanpu/simulations/QPy/hydraulics/a01_test/"
NAMELIST = "/Net/Groups/BSI/work_scratch/ppapastefanou/src/QPy/science/aleksei/augit.nlm"
...
nlm_reader = NamelistReader(NAMELIST)
...
forcing_file = '/Net/Groups/BSI/work_scratch/alipavskii/tmp/drylands_t_forc_03_03_26_lai_modis/Au-GiT_t_1901-2020.dat'
...
namelist_base.base_ctl.output_end_last_day_year.value = 120
...
namelist_base.jsb_forcing_ctl.simulation_length_number.value = 120
namelist_base.jsb_forcing_ctl.forcing_mode.value = ForcingMode.TRANSIENT
...
namelist_base.base_ctl.fluxnet_static_forc_last_yr.value = 2020

namelist_base.base_ctl.quincy_model_name.value = QuincyModelName.LAND
...
gamma_stem_max_min = 30
gamma_stem_max_max = 200
...
root_scale_min = 100.0
root_scale_max = 250.0
