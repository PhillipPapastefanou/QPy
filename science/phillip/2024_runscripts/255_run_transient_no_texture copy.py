...
PARTITION = 'work'
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/2024_bench/255_run_transient_no_texture/"
...
gamma_stem_max_max = 180

# 2. Parameter kappa_stem kg m-3 MPa-1
gamma_stem_res_min = 20
...
vol_porosity_min = 0.45
vol_porosity_max = 0.6

vol_field_cap_min = 0.3
...
hyd_cond_sat_min = 2.0e-8
hyd_cond_sat_max = 1.0e-6
