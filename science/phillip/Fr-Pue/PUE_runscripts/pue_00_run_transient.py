...
PARTITION = 'work'
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/PUE/01_run_transient_fix/"
...
forcing_file = '/Net/Groups/BSI/work_scratch/ppapastefanou/quincy_fluxet22_1.0/transient/FR-Pue_t_1901-2021.dat'
...
namelist_base.base_ctl.output_end_last_day_year.value = 121
...
namelist_base.jsb_forcing_ctl.simulation_length_number.value = 121
...
namelist_base.base_ctl.fluxnet_static_forc_last_yr.value = 2021
namelist_base.base_ctl.forcing_file_last_yr.value = 2021

namelist_base.vegetation_ctl.flag_dynamic_roots.value = False

# Puechabon settingsn
namelist_base.jsb_hydro_nml.qs_soil_awc_prescribe.value = 322.2
namelist_base.jsb_sse_nml.qs_bulk_density.value = 1504
namelist_base.soil_biogeochemistry_ctl.usda_taxonomy_class.value = 84
namelist_base.soil_biogeochemistry_ctl.nwrb_taxonomy_class.value = 27
namelist_base.soil_biogeochemistry_ctl.qmax_org_fine_particle.value = 6.5537123684561 
...
#Set to TeBE
namelist_base.vegetation_ctl.plant_functional_type_id.value = 2
