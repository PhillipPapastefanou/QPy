...
NNODES = 1
PARTITION = 'work'
RUN_DIRECTORY = "../output/01_transient_isi"
...
forcing_file = '/Net/Groups/BSI/work_scratch/ppapastefanou/driver_data/convert_to_quincy/forcing_gfdl-esm4_ssp585_DE-Hai.dat'
