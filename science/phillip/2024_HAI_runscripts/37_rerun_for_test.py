...
PARTITION = 'big'
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/2024_bench/37_rerun_for_test/"
...
namelist_root_path = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/jsbach_spq/2026_35b_run_transient_slurm_array_mort_hyd_fail_mort_g1/output/4014/namelist.slm"
lctlib_root_path = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/jsbach_spq/2026_35b_run_transient_slurm_array_mort_hyd_fail_mort_g1/output/4014/lctlib_quincy_nlct14.def"
...
k_xylem_sat_min = 0.5
k_xylem_sat_max = 25.0

# 2. Parameter kappa_stem kg m-3 MPa-1
gamma_stem_max_min = 40
gamma_stem_max_max = 210

# 2. Parameter kappa_stem kg m-3 MPa-1
gamma_stem_res_min = 10
gamma_stem_res_max = 40

# psi_stem_tlp_min = -2.3
# psi_stem_tlp_max = -1.8

# 3. Parameter kappa_leaf kg m-2 MPa-1
kappa_leaf_min      = 0.005
kappa_leaf_max      = 0.06
...
for j in range(0, n_soil_combs):
    ...
    for i in range(0, number_of_soil_samples):
        ...
        paramlist.phenology_ctl.gdd_t_air_threshold.value = float(8.0)
