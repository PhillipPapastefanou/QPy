...
function calculate_vars(quincy_output::String, ids, d1 ,d2)
    ...
    #df_param = CSV.read(joinpath(quincy_output, "parameters.csv"), DataFrame)
        ...
        vars = ["LAI", "transpiration_avg", "res_flow_avg","gpp_avg", "npp_avg", "total_veg_c", "gc_avg"]
...
root_output_folder = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/2023_bench/66_run_transient_3days_new_mort_new_phen/output"
