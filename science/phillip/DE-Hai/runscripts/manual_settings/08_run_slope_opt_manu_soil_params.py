...
RUN_DIRECTORY = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/kmax_gammastem/08_run_slope_opt_manu_soil_params"
...
slope_leaf_close_min = 3.0
slope_leaf_close_max = 7.0
