...
RUN_DIRECTORY = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/kmax_gammastem/01_initial_variation"
...
for i in range(0, number_of_runs):
    ...
    if i == 0:
        ...
        lctlib[pft].psi50_leaf_close = -2.24382
        ...
        lctlib[pft].k_root_dist = 5.80994
        lctlib[pft].root_scale = 5.03406
