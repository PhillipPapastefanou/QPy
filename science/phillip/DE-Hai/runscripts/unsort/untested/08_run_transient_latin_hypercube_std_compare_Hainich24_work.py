...
RUN_DIRECTORY = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/23_transient_latin_hypercube_with_std_HAINICH_data_full_2024_rs_work_high_gammastem"
...
root_scale_min = 10.0
root_scale_max = 350.0

# 12. Parameter kappa_leaf 
slope_leaf_close_min = 1.0
...
df_parameter_setup['g_res']= np.round(10**g_res_logs,5)
