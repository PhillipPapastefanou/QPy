...
names = ["df_ind", "df_psi_leaf_ind", "df_psi_stem_leaf_ind", "df_psi_stem_leaf_stem_flow_ind"]
for name in names:
    ...
    INPUT_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/2023_bench/70_run_transient_3days_new_mort_new_phen_fix/"
    RUN_DIRECTORY =  f"/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/isimip/ismip_selection_70_{name}/"
