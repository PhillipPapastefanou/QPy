...
for name in names:
    ...
    INPUT_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/2023_bench/66_run_transient_3days_new_mort_new_phen/"
    RUN_DIRECTORY =  f"/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/isimip/ismip_selection_66_{name}/"
