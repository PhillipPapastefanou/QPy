...
for name in names:
    ...
    INPUT_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/2023_bench/69_run_transient_3days_new_mort_new_phen_fix/"
    RUN_DIRECTORY =  f"/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/isimip/ismip_selection_69_{name}/"
