...
number_of_runs = 8*128
n_soil_combs = 4


PARTITION = 'work'
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/jsbach_spq/12_std_transient_slurm_array/"
...
# 14. Parameter silt 
gdd_t_air_req_min  = 420
gdd_t_air_req_max = 420
