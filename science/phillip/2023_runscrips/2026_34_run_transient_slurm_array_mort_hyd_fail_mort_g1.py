...
PARTITION = 'work'
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/jsbach_spq/2026_34_run_transient_slurm_array_mort_hyd_fail_mort_g1/"
...
# 2. Parameter kappa_stem kg m-3 MPa-1
gamma_stem_res_min = 15
gamma_stem_res_max = 35
...
gmins = rescale(slicer.get(), min = gmin_min, max = gmin_max)
...
df_parameter_setup['gmin']= np.round(np.tile(gmins, n_soil_combs),5)
