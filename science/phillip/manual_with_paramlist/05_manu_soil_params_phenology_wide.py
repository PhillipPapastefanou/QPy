...
RUN_DIRECTORY = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/pheno_hydro/05_manu_soil_params_phenology"
...
# 6. Parameter kappa_leaf 
slope_leaf_close_min = 5.0
slope_leaf_close_max = 10.0
...
# 11. Parameter silt 
gdd_t_air_thres_min  = 9.0
gdd_t_air_thres_max = 9.0

# 12. Parameter silt 
gdd_t_air_req_min  = 400
gdd_t_air_req_max = 400

# 13. Parameter silt 
k_gdd_min  = 0.0154
k_gdd_max  = 0.0154

# 14. Parameter kappa_stem
kappa_leaf_min = 2 * 10**(-4)
kappa_leaf_max = 2 * 10**(-3)
...
df_parameter_setup['kappa_leaf'] = np.round(kappa_leaves,7)
...
df_parameter_setup['gdd_t_air_threshold']= np.round(gdd_t_air_thresholds, 5)
df_parameter_setup['gdd_t_air_req']= np.round(gdd_t_air_reqs, 5)
df_parameter_setup['k_gdd']= np.round(k_gdd_s, 5)
