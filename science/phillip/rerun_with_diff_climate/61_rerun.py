...
names = ["df_psi_stem_ind", "df_psi_stem_leaf_ind"]
for name in names:
    ...
    PARTITION = 'work'
    INPUT_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/2023_bench/61_run_transient_g1_low_gamma_leaf/"
    RUN_DIRECTORY =  f"/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/isimip/ismip_selection_61_{name}/"
