...
PARTITION = 'work'
INPUT_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/jsbach_spq/27_transient_slurm_array_dyn_roots_off/"
RUN_DIRECTORY =  "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/isimip/on27_df_psi_stem_stem_flow_03_18/"
...
df_run = pd.read_csv(os.path.join(INPUT_DIRECTORY, "post", "ismip_selection_27_df_psi_stem_stem_flow_03_18.csv"))
