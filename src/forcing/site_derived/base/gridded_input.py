...
from src.forcing.site_derived.base.fluxnet22_jake import Fluxnet2022_Jake
from src.forcing.site_derived.converter.settings import Verbosity
from src.forcing.site_derived.converter.settings  import ProjectionScenario
...
class NdepositionForcing(GriddedInput):
    ...
    def extract(self, lon, lat, year_min, year_max):
...
class Phosphorus_Inputs(GriddedInput):
    ...
    def extend_search(self, ds : netCDF4.Dataset, var):
        ...
        # Todo improve this extended search algorithm
