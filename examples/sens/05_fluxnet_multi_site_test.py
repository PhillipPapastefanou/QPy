...
namelists, forcing_files = env_input.parse_multi_sites(namelist    = namelist_base,
                                                          sitelist = [],
                                                          site_list_type = SimulationSiteType.ALL)
...
df_parameter_setup['id'] = np.arange(0, len(namelists))
df_parameter_setup['fid'] = [key for key in namelists]
