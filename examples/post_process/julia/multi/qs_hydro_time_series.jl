...
rt_path_hyd = "/Net/Groups/BSI/scratch/ppapastefanou/simulations/QPy/jsbach_spq/2026_34_run_transient_slurm_array_mort_hyd_fail_mort_g1"
...
#hist(df_psi_stem[!,:stem_flow_rmse_23 ])
...
df_psi_stem_stem_flow_23 = filter(row -> (row.psi_stem_rmse_23 < psi_stem_err_ref) & 
    ...
    (row.gpp_rmse_23 < 3.7) & (row.le_rmse_23 < 37) , df);
